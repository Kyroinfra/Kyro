<script lang="ts">
  ...
  async function loadThree() {
    try {
      ...
      // Inner solid with slight glow feel
      ...
      const ring2 = new THREE.Mesh(
        ...
        new THREE.MeshBasicMaterial({ color: 0x00cc66, transparent: true, opacity: 0.1 })
      );
      ...
      const animate = () => {
        ...
        ico.rotation.x = t * 0.18 + tmy * 0.15;
        ico.rotation.y = t * 0.26 + tmx * 0.15;
        inner.rotation.copy(ico.rotation);

        ring.rotation.y  = t * 0.08;
        ring2.rotation.z = t * 0.05 + Math.PI / 6;

        particles.rotation.y = -t * 0.04 + tmx * 0.05;
        particles.rotation.x =  t * 0.02 + tmy * 0.05;
...
<svelte:head>
  ...
  <meta name="description" content="Upload documents, ask questions in plain English. Everything runs on your infrastructure. OpenAI never sees a byte." />
</svelte:head>
...
<div class="landing">
  ...
  <!-- ══════════════════════ STATUS BAR ══════════════════════ -->
  <div class="statusbar" style="--s: {cfg.color}" role="status" aria-live="polite">
    ...
    <section class="hero" bind:this={heroSection} aria-label="Hero">
      <div class="hero-left">
        ...
        <p class="hero-sub reveal">
          Upload PDFs, contracts, or codebases — then ask questions
          in plain English. Everything runs on your infrastructure.
      ...
      <div class="hero-canvas-wrap" aria-hidden="true">
        {#if canvasVisible}
          <canvas bind:this={canvasEl} class="hero-canvas" class:loaded={threeLoaded}></canvas>
    ...
    <section class="demo-section reveal" aria-labelledby="demo-heading">
      ...
      <div class="demo-grid">
        <div class="demo-text">
          ...
          <p class="demo-desc">
            The <code>/ask</code> endpoint accepts a question and a list of
            file IDs. It retrieves relevant chunks via vector similarity, builds
            a grounded prompt, and streams back an answer with source citations
...
<span class="c-success">// {'{'} type: "done" {'}'}</span></code></pre>
    ...
    <section class="features-section" aria-labelledby="features-heading">
      ...
      <h2 id="features-heading" class="section-title reveal">Built different by design.</h2>
    ...
    <section class="steps-section" aria-labelledby="steps-heading">
      ...
      <h2 id="steps-heading" class="section-title reveal">Up and running in minutes.</h2>
    ...
    <section class="cta-section reveal" aria-labelledby="cta-heading">
      ...
      <div class="cta-inner">
        ...
        <h2 id="cta-heading" class="cta-title">Your knowledge base.<br />Your rules.</h2>
        <p class="cta-sub">
        ...
        <div class="cta-btns">
          ...
          <a href="/docs" class="btn-ghost btn-lg">explore the docs →</a>
        </div>
...
<style>
  ...
  .status-text { color: var(--s); font-weight: 600; }
  ...
  @media (prefers-reduced-motion: reduce) {
    ...
    .dot-pulse, .badge-dot, .canvas-glow, .fallback-ico, .term-cursor {
      animation: none;
    }
    .btn-primary:hover, .btn-ghost:hover, .feat-card:hover, .step-card:hover {
      transform: none;
    }
  }
</style>
