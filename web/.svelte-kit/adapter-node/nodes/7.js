import * as server from '../entries/pages/(app)/dashboard/keys/_page.server.ts.js';

export const index = 7;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(app)/dashboard/keys/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/(app)/dashboard/keys/+page.server.ts";
...
export const stylesheets = ["_app/immutable/assets/Button.0TkAx1vZ.css","_app/immutable/assets/Card.YXoaD-YW.css","_app/immutable/assets/Badge.C3IP6rTe.css","_app/immutable/assets/ConfirmDialog.MZXjpw2f.css","_app/immutable/assets/Modal.9NjLaI47.css","_app/immutable/assets/7.DtRtg0HR.css"];
export const fonts = [];
