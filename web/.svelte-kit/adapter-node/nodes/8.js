import * as server from '../entries/pages/(app)/dashboard/settings/_page.server.ts.js';

export const index = 8;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(app)/dashboard/settings/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/(app)/dashboard/settings/+page.server.ts";
...
export const stylesheets = ["_app/immutable/assets/Button.BCXzFm4h.css","_app/immutable/assets/Card.BN6XTZFe.css","_app/immutable/assets/Badge.OH5zYe3V.css","_app/immutable/assets/ConfirmDialog.DH23h5hh.css","_app/immutable/assets/Modal.C2Xn3KKw.css","_app/immutable/assets/8.CB62I0E4.css"];
export const fonts = [];
