  ...
  const audiences = [
    {
      icon: "⚖",
      label: "Legal teams",
      desc: "Contract review, clause extraction, matter research — without sending client files to OpenAI.",
    },
    {
      icon: "⊞",
      label: "Research teams",
      desc: "Query across hundreds of papers. Find the passage you half-remember without re-reading everything.",
    },
    {
      icon: "◎",
      label: "Support teams",
      desc: "Ground your support bot in your actual product docs. No hallucinated feature names.",
    },
    {
      icon: "⌥",
      label: "Developers",
      desc: "Embed a fully-featured RAG API into your product. No ML infra to manage.",
    },
  ];
...
<div class="landing">
  ...
  <div class="tagbar" role="banner">
    ...
    <span class="tagbar-sep" aria-hidden="true">·</span>
    <span class="tagbar-item tagbar-muted"
      >No vendor lock-in. No data egress. Ever.</span
    >
  </div>
    ...
    <section class="demo-section reveal" aria-labelledby="demo-heading">
      ...
      <div class="demo-grid">
        <div class="demo-text">
          ...
          <p class="demo-desc">
            The <code>/ask</code> endpoint accepts a question and optional file IDs.
...
<span class="c-kw">const</span> stream <span class="c-dim">=</span> <span
              ...
              > <span class="c-fn">fetch</span><span class="c-brace">(</span
              ><span class="c-str">"/api/v2/files/ask"</span><span class="c-dim"
                >,</span
  ...
  headers<span class="c-dim">:</span> <span class="c-brace">{"{"}</span> <span
              ...
              ><span class="c-dim">:</span> process<span class="c-dim">.</span
  ...
  body<span class="c-dim">:</span> <span class="c-prop">JSON</span><span
                class="c-dim">.</span
              ><span class="c-fn">stringify</span><span class="c-brace"
                >({"{"}</span
              >
    ...
    fileIds<span class="c-dim">:</span>  <span class="c-brace">[</span><span
              ...
              ><span class="c-dim">,</span> <span class="c-str">"uuid-2"</span
              ><span class="c-brace">],</span>
...
<span class="c-success">// {"{"} type: "done" {"}"}</span></code
    ...
    <section class="cta-section reveal" aria-labelledby="cta-heading">
      ...
      <div class="cta-inner">
        ...
        <p class="cta-sub">
          No credit card. No vendor lock-in. No data egress. Your documents stay
          on your server, forever.
        </p>
        <div class="cta-btns">
